...
// 1. Import 'Bloom' instead of 'SelectiveBloom'
...
export function Room(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      {/* Lights */}
      <directionalLight intensity={2} position={[0, 5, 0]} color="white" />
      <ambientLight intensity={0.5} />

      {/* 2. Use Standard Bloom (Stable) */}
      <EffectComposer>
        <Bloom 
            luminanceThreshold={1} // Only very bright things will glow
            mipmapBlur // Makes the glow softer and higher quality
      ...
      {/* 3. THE SCREEN: We make it "Emissive" (Emit light). 
         This naturally triggers the Bloom effect without crashing.
      */}
      <mesh
      ...
      >
        <meshBasicMaterial 
            color={[1.5, 1.5, 4]} // R, G, B (Values > 1 make it glow)
            toneMapped={false}   // Crucial: lets the color go beyond white
        />
      </mesh>
